...
import { useGoogleSignIn, useGitHubSignIn } from "@/hooks/useAuth";
...
export const OAuthButton = ({ provider }: OAuthButtonProps) => {
    ...
    const isThisLoading = oauthLoading === provider;
    const isOtherLoading = oauthLoading !== null && oauthLoading !== provider;
