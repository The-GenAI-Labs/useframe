...
const AuthForm = ({ mode }: AuthFormProps) => {
  ...
  return (
    <div className="w-[60%] max-w-sm flex flex-col gap-6" style={{margin:"auto"}}>
      ...
      <div className="flex flex-col gap-3">
        <Button type="button" variant="outline" className="w-full text-gray-700 h-11">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 text-gray-600 h-11"
                {...register("name")}
              />
            </div>
        ...
        <div className="flex flex-col gap-1">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-9 text-gray-600 ml-10 h-11"
              {...register("email")}
            />
          </div>
          {errors.email && (
        ...
        <div className="flex flex-col gap-1">
          ...
          {isLogin && (
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-xs text-zinc-500 hover:text-zinc-800">
                Forgot password?
              </Link>
            </div>
          )}
        ...
        <Button
          ...
          className="w-full h-11 bg-orange-100 hover:bg-orange-200 text-orange-700 font-medium border-0 shadow-none"
          variant="outline"
        >
