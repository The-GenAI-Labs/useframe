    ...
    return (
        <div className="flex flex-col h-full w-full px-8 py-10">
            <div className="flex flex-col gap-1 mb-8">
                <h1 className="text-2xl font-semibold text-black/85 tracking-tight">Templates</h1>
                <p className="text-sm text-black/40">Pre-built page templates to get started fast.</p>
            </div>
            <div className="flex-1 flex items-center justify-center">
                <div className="flex flex-col items-center gap-3 text-center">
                    ...
                    <p className="text-sm font-medium text-black/40">Templates coming soon</p>
                </div>
            </div>
        </div>
    );
